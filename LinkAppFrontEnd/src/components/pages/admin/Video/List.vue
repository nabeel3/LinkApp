...
<div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2>Videos</h2></div>
                    <div class="col-sm-4">
                        <RouterLink to='/add/video' type="button" class="btn btn-info add-new"><i class="fa fa-plus"></i> Add New</RouterLink>
                    </div>
                </div>
            </div>
...
<script>
import VideoDataService from "../../../../services/TutorialDataService";
export default {
  name: "video-list",
  data() {
    return {
